.PHONY: help install dev-up dev-down test test-unit test-integration lint format type-check check seed run-submission migrate
...
help:
	...
	@echo "  run-submission    Run the submission service locally"
