...
from services.pricing.api.v1 import router as v1_router
...
async def lifespan(_app: FastAPI) -> AsyncIterator[None]:
    ...
    logger.info("pricing service starting", environment=settings.environment)
    yield
    logger.info("pricing service stopping")


def create_app() -> FastAPI:
    """Create and configure the FastAPI application."""
    app = FastAPI(
        title="Helios Pricing Service",
        description=(
            "Formal quote generation from AI pricing suggestions. "
