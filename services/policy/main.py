...
from services.policy.api.v1 import router as v1_router
...
async def lifespan(_app: FastAPI) -> AsyncIterator[None]:
    ...
    logger.info("policy service starting", environment=settings.environment)
    yield
    logger.info("policy service stopping")


def create_app() -> FastAPI:
    """Create and configure the FastAPI application."""
    app = FastAPI(
        title="Helios Policy Service",
        description=(
            "Policy binding, lifecycle, and endorsements. "
